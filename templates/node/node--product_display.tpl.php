    ...
    <div class="dexp_tab_wrapper default clearfix" id="dexp_tab_wrapper_product_detail"> 
        <ul class="nav nav-tabs">
            ...
            <li class=""><a data-toggle="tab" href="#product_additional">
             ...
             <li class=""><a data-toggle="tab" href="#product_directions">
                <i class="tab-icon fa "></i>Directions</a></li>
            <li class=""><a data-toggle="tab" href="#product_video">
                <i class="tab-icon fa "></i>Video</a></li>
        ...
        <div class="tab-content" style="border:1px solid #e5e5e5; padding:10px 20px; border-radius:3px;">
            ...
            <div class="tab-pane" id="product_additional">
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                      <td>Skin Type</td>
                      <td><?php print render($content['product:field_skin_type']);?></td>
                    </tr>
                    <tr>
                      <td>Size</td>
                    ...
                    <tr>
                      <td>Ingredients</td>
                      <td><?php print render($content['product:field_ingredients']);?></td>
                    </tr>
                  </tbody>
                </table>
            </div>
            <div class="tab-pane" id="product_directions">
